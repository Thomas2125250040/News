...
public class CustomAdaptor extends RecyclerView.Adapter<CustomViewHolder>{
    ...
    public CustomAdaptor(MainActivity context, List<NewsHeadlines> list) {
    }

    @NonNull
    @Override
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CustomViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_berita_komponen, parent, false));
    }
